...
INSERT INTO "new_Book" ("categoryId", "description", "favorite", "id", "image", "link", "rate", "status", "title", "typeId", "userId") SELECT "categoryId", "description", "favorite", "id", "image", "link", "rate", "status", "title", "typeId", "userId" FROM "Book";
DROP TABLE "Book";
