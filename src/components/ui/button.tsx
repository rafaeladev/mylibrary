...
const buttonVariants = cva(
  "relative inline-flex items-center justify-center  text-sm font-light  offset-background transition-colors  disabled:pointer-events-none disabled:opacity-50  ",
  {
    variants: {
      variant: {
        default:
